    ...
    <footer className="ant-layout-footer" style={{ padding: '0px' }}>
      <footer className="ant-pro-global-footer">
        <div className="ant-pro-global-footer-links">
          <a title="Fim" target="_blank" rel="noopener noreferrer" href="https://fim.com.cn">
            Fim
          </a>
          <a
            title="github"
            ...
            href="https://github.com/fim/"
          >
            <i aria-label="图标: github" className="anticon anticon-github">
              <svg
          ...
          <a title="Ant Design" target="_blank" rel="noopener noreferrer" href="https://fim.com.cn">
            飞沐科技
          </a>
        </div>
