export default {
  ...
  'account-settings.security.email': '邮箱号码',
  'account-settings.security.change-email': '修改邮箱',
  ...
  'account-settings.security.change-current-password': '修改当前密码',
  'account-settings.security.change-current-email': '修改当前邮箱',
  'account-settings.security.change-current-phone': '修改当前手机号',
  'account-settings.security.get-verification-code': '获取验证码',
  'account-settings.security.verification-code.required': '请输入验证码',
  'account-settings.security.select-email-or-mobile': '请选择手机号或邮箱',
  'account-settings.security.new-password': '请输入新密码',
  'account-settings.security.confirm-new-password': '确认密码',
  'account-settings.security.modify-success': '修改成功',
  'account-settings.security.password.required': '密码不能为空',
  'account-settings.security.password.strength.msg': '请输入6 - 16个字母或数字',
  'account-settings.security.confirm-password.required': '请确认密码',
  'account-settings.security.verification-code.no-empty': '验证码不能为空',
  'account-settings.security.new-phone-number': '请输入新的手机号码',
