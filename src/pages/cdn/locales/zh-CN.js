export default {
  ...
  // FIM
  'cdn.form.field.1.origin': '加速域名',
  'cdn.form.field.2.site': '源站地址',
  'cdn.form.field.3.acc-type': '加速类型',
  'cdn.form.field.4.backhost': '回源方式',
  'cdn.form.field.4.host-protocol': '源站协议',
  'cdn.form.field.5.acc-server': '加速服务器',
  'cdn.form.field.6.order-set': '购买套餐',
  'cdn.form.field.7.order-total-time': '购买期限',
  'cdn.form.field.8.price': '价格',
};
